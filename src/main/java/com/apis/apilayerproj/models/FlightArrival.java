...
public class FlightArrival {
	...
	public String toString() {
		return "Arrival [airport=" + airport + ", timezone=" + timezone + ", iata=" + iata + ", icao=" + icao
				+ ", terminal=" + terminal + ", gate=" + gate + ", baggage=" + baggage + ", delay=" + delay
				+ ", scheduled=" + scheduled + ", estimated=" + estimated + ", actual=" + actual + ", estimated_runway="
				+ estimated_runway + ", actual_runway=" + actual_runway + "]";
	}
